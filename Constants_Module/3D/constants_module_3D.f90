...
!********************************************************************************
!* @file constants_module_3D.f90
!*
!* @Constants module for 3D version of BAFFLE. Can control much of the behaviour
!* of BAFFLE via this module: Fortran 90 version.
!*
...
!	Set save file output directory:
	character(len=100):: SavePath = "/home/alpha/ath4/summer2017/HydroCode/D_RAN_ISO_2PHASE_LOW_RHO/"		
...
!	Some system constants defaults:
	Real*8 ::NcXrdefault=100.d0,NcYrdefault=100.d0,NcZrdefault=100.d0
	Real*8 :: tdefault=0.85d0
...
!	Isothermal Settings:
	...
	Logical :: IsoBoolDefault= .TRUE.					!" True=> Isothermal Setup ON	False => Adiabatic Setup ON"
	...
	LOGICAL :: TwoPhaseBool = .TRUE.					!Toggles Two Phase Isothermal Setup. TRUE => Two Phase On	FALSE => Two Phase Off
