...
!********************************************************************************
!* @file init_conds_Blob-Test-Explosion.f90
!*
!* @Initial Conditions subroutine for 2D Explosion of over-pressured point next to
!* high density blob: Fortran 90 version.
!*
